overall_func MATLAB Python Package
...
2. Installing the overall_func Package

A. Change to the directory that contains the file setup.py and the subdirectory 
overall_func. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the overall_func Package

The overall_func package is on your Python path. To import it into a Python script or 
session, execute:
