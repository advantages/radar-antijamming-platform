reward_gene MATLAB Python Package
...
2. Installing the reward_gene Package

A. Change to the directory that contains the file setup.py and the subdirectory 
reward_gene. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the reward_gene Package

The reward_gene package is on your Python path. To import it into a Python script or 
session, execute:
