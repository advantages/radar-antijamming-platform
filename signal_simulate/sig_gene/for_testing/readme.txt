sig_gene MATLAB Python Package
...
2. Installing the sig_gene Package

A. Change to the directory that contains the file setup.py and the subdirectory sig_gene. 
...
3. Using the sig_gene Package

The sig_gene package is on your Python path. To import it into a Python script or 
session, execute:
