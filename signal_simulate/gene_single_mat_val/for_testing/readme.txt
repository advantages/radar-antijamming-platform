gene_single_mat_val MATLAB Python Package
...
2. Installing the gene_single_mat_val Package

A. Change to the directory that contains the file setup.py and the subdirectory 
gene_single_mat_val. If you do not have write permissions, copy all its contents to a 
...
3. Using the gene_single_mat_val Package

The gene_single_mat_val package is on your Python path. To import it into a Python script 
or session, execute:

    import gene_single_mat_val
