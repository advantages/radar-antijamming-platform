collector_gene MATLAB Python Package
...
2. Installing the collector_gene Package

A. Change to the directory that contains the file setup.py and the subdirectory 
collector_gene. If you do not have write permissions, copy all its contents to a 
...
3. Using the collector_gene Package

The collector_gene package is on your Python path. To import it into a Python script or 
session, execute:
