...
def get_args():
    ...
    parser.add_argument('--logdir', type=str, default='log_mbrl')
...
def test_dqn_icm(args=get_args()):
    ...
    test_envs = DummyVectorEnv(
        [lambda: radarenv.RadarGameEnv(episode=episode,num_sf=num_sf,num_sp=num_sp,jammer_type=jammer_type,history_len=his_len) for _ in range(args.test_num)]
    )
    # seed
    ...
    # log
    log_path = os.path.join(args.logdir, args.task, 'dqn_icm_100_epoch_3_3_freq6')
