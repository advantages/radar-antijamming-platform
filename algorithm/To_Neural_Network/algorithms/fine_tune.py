...
class AdapterModule(nn.Module):
    def __init__(self,
        ...
        self.proj_down = nn.Linear(in_features=in_feature, out_features=in_feature*2)
        self.proj_up = nn.Linear(in_features=in_feature*2, out_features=in_feature)
...
class Block(nn.Module):
    def __init__(self, config):
        ...
        self.mlp = MLP(config)
        self.Adapter=AdapterModule(config.n_embd)
